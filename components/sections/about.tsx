        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="max-w-2xl">
            ...
            <div className="space-y-5 text-lg leading-relaxed text-pretty text-foreground">
              ...
              <p>
                {brand.name} accoglie bambini, ragazzi e adulti in un ambiente dedicato alla crescita artistica e al piacere del movimento.
              </p>
              <p>
                La scuola propone percorsi di ballo sportivo e danza di coppia pensati per accompagnare ogni allievo con attenzione, ascolto e continuita.
              </p>
              <p>
